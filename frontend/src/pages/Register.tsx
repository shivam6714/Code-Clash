  ...
  return (
    <div className="min-h-[calc(100vh-64px)] bg-dark-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center space-y-2">
        ...
        <p className="text-xs text-gray-400 font-mono">Join the ranked 1v1 DSA arena</p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-dark-900 py-8 px-6 rounded-2xl border border-zinc-800 sm:px-10 space-y-5">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="username" className="block text-xs font-mono font-bold text-gray-300 uppercase tracking-wider mb-1">
                Username
              </label>
              <input
                id="username"
